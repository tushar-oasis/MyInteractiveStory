package com.oasis.interactivestory.model;

import com.oasis.interactivestory.R;

/**
 * Created by Oasis on 30-04-2016.
 */
public class Story {
    ...
    public Story() {
        ...
        mPages[0] = new Page(
                ...
                new Choice("Continue home to Earth", 2), false);
        ...
        mPages[1] = new Page(
                ...
                new Choice("Explore the rover", 4), false);
        ...
        mPages[2] = new Page(
                ...
                new Choice("Continue home to Earth", 6), false);
        ...
        mPages[3] = new Page(
                ...
                new Choice("Continue towards the faint light", 5), false);
        ...
        mPages[4] = new Page(
                ...
                new Choice("Return to Earth", 6), false);
